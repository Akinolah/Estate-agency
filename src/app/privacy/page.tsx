...
export default function PrivacyPolicyPage() {
    ...
    return (
        <div className="container py-12 md:py-16 max-w-4xl mx-auto prose prose-sm sm:prose-base lg:prose-lg dark:prose-invert prose-headings:font-bold prose-a:text-primary hover:prose-a:underline">
            ...
            <p>
                Welcome to Estate Agency. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice or our practices with regard to your personal information, please contact us at privacy@estateagency.ng.
            </p>

            <p>
                This privacy notice describes how we might use your information if you visit our website at {websiteUrl}, use our mobile application (if applicable), or engage with us in other related ways ― including any sales, marketing, or events (we refer to them collectively in this privacy notice as the "<strong>Services</strong>").
            </p>
            ...
            <ul>
                ...
                <li><strong>"App,"</strong> we are referring to any application of ours that references or links to this policy, including any listed above (if applicable).</li>
            ...
            <p>
                <strong>Personal information you disclose to us:</strong> We collect personal information that you voluntarily provide to us when you register on the Services (if applicable), express an interest in obtaining information about us or our products and Services, when you participate in activities on the Services (such as submitting inquiries or saving properties) or otherwise when you contact us.
            </p>
            <p>
                The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make and the products and features you use. The personal information we collect may include the following: Name, Phone Number, Email Address, Mailing Address (if provided), Usernames (if applicable), Passwords (if applicable), Contact Preferences, Contact or Authentication Data, and other similar information provided through forms.
            </p>
            <p>
            ...
            <ul>
                ...
                <li>Fulfill and manage your property inquiries or requests.</li>
            ...
            <p>
                 We may process or share your data that we hold based on the following legal basis: Consent, Legitimate Interests, Performance of a Contract, Legal Obligations, Vital Interests. More specifically, we may need to process your data or share your personal information in the following situations: Business Transfers, Affiliates, Business Partners (e.g., partner agents if necessary to fulfill your request, with your awareness).
            </p>

             <h2>4. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
            <p>
                We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law (such as tax, accounting or other legal requirements in Nigeria).
             </p>
            ...
            <p>
             ...
             <p>
                Depending on your location (e.g., Nigeria Data Protection Regulation - NDPR), you may have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; and (iv) if applicable, to data portability. In certain circumstances, you may also have the right to object to the processing of your personal information. To make such a request, please use the contact details provided below. We will consider and act upon any request in accordance with applicable data protection laws.
             </p>
            ...
            <p>
                If you have questions or comments about this notice, you may email us at privacy@estateagency.ng or by post to:
            </p>
            <p>
                Estate Agency<br />
