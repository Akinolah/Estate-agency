...
export function VirtualToursSection({ properties }: VirtualToursSectionProps) {
  ...
  const openTourModal = (url: string) => {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {propertiesWithTours.map(property => (
             ...
             <div key={property.id}>
                 ...
                 {/* Example:
                 <Button onClick={() => openTourModal(property.virtualTourUrl!)} className="mt-2 w-full">
